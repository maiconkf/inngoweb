			...
			<div class="content">
				...
				<div class="row main-text">
					<div class="col m7 center-block">
						<h2 class="f60 white-text center-align hd-medium">Meetings and Conferences</h2>
					</div>
				</div>
				<div class="row">
		...
		<div id="intern" class="clearfix events">
			<div class="container clearfix">
				<div class="col m7 info">
					<h1 class="f200 hd-medium">Events</h1>
			...
			<div class="container clearfix">
				<div class="col m7 center-block">
					<h2 class="f60 hd-medium center-align">Why choose us?</h2>
					<div class="text">
						<p class="f18 a-light">
				...
				<div class="our-events clearfix">
					<div class="col m6 left">
						<div class="col m11 center-block">
							<h2 class="f58 hd-medium">Our events room</h2>
							<p class="f18 a-light">
				...
				<div class="col m6 box clearfix">
					<div class="col m8 center-block">
						<form id="quotes" method="post">
							...
							<div class="input-field col m12">
								<p class="col m12 f19 a-light"><i>Event Dates</i></p>
								<div class="box-date col m5 left">
									<input type="text" id="start" name="start" class="f22 a-light datepicker col m12" value="Start" required>
									<span class="caret"></span>
								</div>
								<div class="box-date col m5 left">
									<input type="text" id="end" name="end" class="f22 a-light datepicker col m12" value="End" required>
									<span class="caret"></span>
								</div>
							</div>
							<div class="input-field col m12">
								<input type="text" id="name" name="name" class="f22 a-light" value="Your Name" required>
							</div>
							<div class="input-field col m12">
								<input type="text" id="name" name="name" class="f22 a-light" value="Company/Organization" required>
							</div>
							<div class="input-field col m12">
								<input type="email" id="email" name="email" class="f22 a-light" value="Email" required>
								<label for="email" data-error="wrong"></label>
							</div>
							<div class="input-field col m12">
								<input type="tel" id="tel" name="tel" class="f22 a-light" value="Phone Number" required>
							</div>
							<div class="input-field col m12">
								<input type="text" id="additional" name="additional" class="f22 a-light" value="Additional Information (Optional)"/>
							</div>
							<br clear="both">
							<input type="submit" value="Get a Quote Now" class="btn-large f20 white-text center-block" />
						</form>
	 				</div>
				</div>
				<div class="col m6">
					<div class="col m10 valign-wrapper right">
						<p class="f180 hd-light valign">Quote</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="modal" class="hide">
			...
			<div class="container">
				...
				<div class="text-left col m2">
					<a href="./" class="hd-medium f44 white-text active">Home</a>
