...
<html lang="en">
	...
	<body>
			...
			<div class="content">
				...
				<div class="row main-text">
					<div class="col m7 center-block">
						<h2 class="f60 white-text center-align hd-medium">Accomodations</h2>
					</div>
				</div>
				<div class="row">
		...
		<div id="intern" class="clearfix">
			<div class="info">
				<h1 class="f192 hd-medium center-align">Accomodations</h1>
			...
			<div class="container">
				<div class="card col m6">
					<div class="card-image">
						<img class="responsive-img" src="http://placehold.it/627x517">
					</div>
					<div class="card-content">
						<div class="name">
							<h2 class="activator center-align f58 hd-light">Deluxe</h2>
							<a href="javascript:;" class="view-more btn-large f20 a-regular white-text">View More</a>
						</div>
						<div class="extended hide">
							<div class="col m3">
								<h2 class="activator center-align f58 hd-light">Deluxe</h2>
								<a href="javascript:;" class="view-more btn-large f20 a-regular white-text">View Less</a>
							</div>
							<div class="col m5">
								<div class="col m11">
							...
							<div class="col m4">
								<div class="col m11">
									<div class="check-booking">
										...
										<br clear="all">
										<a href="javascript:;" class="btn f16 a-regular white-text">Check avaliability</a>
									</div>
								</div>
							</div>
						</div>
		...
		<div id="modal" class="hide">
			...
			<div class="container">
				...
				<div class="text-left col m2">
					...
					<a href="javascript:;" class="hd-medium f44 white-text active">Accomodations</a>
