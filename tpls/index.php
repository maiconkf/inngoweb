...
<html lang="en">
	...
	<body>
		...
		<div id="rooms">
			<div class="container">
				<div class="col m5">
					<h3 class="hd-medium f58">Accommodations</h3>
					<p class="a-light f16">
		...
		<div id="restaurants">
			<div class="container">
				<h2 class="f200 hd-medium col offset-m1">Restaurants</h2>
				<div class="offset-m1 col m6">
		...
		<div id="more" class="black clearfix">
			<div class="container">
				<h2 class="f120 hd-medium white-text center-align">More?</h2>
				<div class="clearfix">
					<div class="col m12 center-block">
						<div class="col m5 left offset-m1">
							<div class="col m11 box-news white right">
								<h3 class="hd-medium f103">News</h3>
								...
								<a href="javascript:;" class="a-regular f20">Learn More</a>
							</div>
						</div>
						<div class="col m5 right">
							<div class="col m11 box-experiences white">
								...
								<div class="description left">
									<h3 class="hd-medium f50">Experiences</h3>
									<p class="a-light f20">Be updated on everything that’s happening on your network. Fabio is awesome too and this copy isn’t final.</p>
									<a href="javascript:;" class="a-regular f20">Learn More</a>
								</div>
							</div>
						...
						<div class="col m6 left">
							<div class="box-facilities white clearfix">
								...
								<div class="description left">
									<h3 class="hd-medium f50">Facilities</h3>
