...
<html lang="en">
	...
	<body>
			...
			<div class="content">
				...
				<div class="row main-text">
					<div class="col m7 center-block">
						<h2 class="f60 white-text center-align hd-medium">Experiences</h2>
					</div>
				</div>
				<div class="row">
		...
		<div id="intern" class="clearfix">
			<div class="info">
				<h1 class="f192 hd-medium center-align">Experiences</h1>
		...
		<div id="modal" class="hide">
			...
			<div class="container">
				...
				<div class="text-right col m2">
					<a href="javascript:;" class="hd-medium f44 white-text active">Experiences</a>
