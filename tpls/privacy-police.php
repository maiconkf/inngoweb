		...
		<div id="intern" class="clearfix">
			<div class="container">
				<div class="col m7 center-block">
					<h1 class="f60 hd-medium center-align">Privacy Policy</h1>
					<div class="text">
						<p>
						...
						<h2 class="hd-medium f30">Terms of Use</h2>
						<p>
						...
						<h2 class="hd-medium f30">Restrictions for Direction</h2>
						<p>
							The Club provides a full time concierge service, to arrange flights to and from Saint-Barthélemy, VIP Service, shopping delivered to the villa prior to arrival, babysitting, restaurant reservations, car rental, in-villa personal coach, etc.
						</p>
						<p>
						...
						<h2 class="hd-medium f30">Conditions for Hosts</h2>
						<p>
							The Club provides a full time concierge service, to arrange flights to and from Saint-Barthélemy, VIP Service, shopping delivered to the villa prior to arrival, babysitting, restaurant reservations, car rental, in-villa personal coach, etc.						</p>
						</p>
					</div>
				</div>
			</div>
